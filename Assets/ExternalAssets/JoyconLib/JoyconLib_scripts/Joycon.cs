...
namespace JoyconLib
{
    public class Joycon
    {
        ...
        private Vector3 acc_gravity;
        private bool isFirstAccValue = true;
        ...
        {
            //return gyr_g;
            return new Vector3(-gyr_g.y, gyr_g.z, -gyr_g.x) / Mathf.PI;
        }
        ...
        public Vector3 GetAccelWithoutGravity()
        {
            var dAcc = acc_g - acc_gravity;
            return new Vector3(-dAcc.y, dAcc.z, -dAcc.x);
        }
        ...
        private int ProcessIMU(byte[] report_buf)
        {
            ...
            {
                acc_gravity = acc_g;
                isFirstAccValue = false;
            }
            else
            {
                float alpha = 0.8f;
                acc_gravity = alpha * acc_gravity + (1 - alpha) * acc_g;
            }
