...
//     version 1.14.0
//     from Assets/Settings/InputSystem/GameInputs.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Settings/InputSystem/GameInputs.inputactions".
/// </summary>
/// <remarks>
...
public partial class @GameInputs: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""Common"",
            ""id"": ""2be64300-17f8-4cb1-836a-f0c28c49d1ea"",
            ""actions"": [
                {
                    ""name"": ""Decide"",
                    ""type"": ""Button"",
                    ""id"": ""6a5b8d55-c7d4-4948-8eb5-93698bf7eab6"",
                ...
                },
                {
                    ""name"": ""Cancel"",
                    ""type"": ""Button"",
                    ""id"": ""9b8b5390-88e7-43ec-a421-67f633c2b860"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""c3ec41da-81e1-4635-8121-2612c25df1e3"",
                    ""path"": ""<Keyboard>/space"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""7f7a67e2-f130-4caf-980f-938512673c20"",
                ...
                {
                    ""name"": """",
                    ""id"": ""6ae9902c-9080-46c8-8924-8bbf10b9121c"",
                ...
                {
                    ""name"": """",
                    ""id"": ""8b75961b-3b9d-4690-8d1b-976ea25c3061"",
    ...
    ""controlSchemes"": []
        ...
        m_Common_Decide = m_Common.FindAction("Decide", throwIfNotFound: true);
        m_Common_Cancel = m_Common.FindAction("Cancel", throwIfNotFound: true);
    }

    ~@GameInputs()
    {
        UnityEngine.Debug.Assert(!m_Common.enabled, "This will cause a leak and performance issues, GameInputs.Common.Disable() has not been called.");
    }
    ...
    private readonly InputAction m_Common_Decide;
    ...
    public struct CommonActions
    {
        ...
        /// </summary>
        public CommonActions(@GameInputs wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "Common/Decide".
        /// </summary>
        public InputAction @Decide => m_Wrapper.m_Common_Decide;
        /// <summary>
        /// Provides access to the underlying input action "Common/Cancel".
        /// </summary>
